...
In this version of the code, many examples have been made into proper Grammar Factories, and they are available as both a Grammar Factory and as an example.  The following documentation only refers to it as an example.
