...
class Utf8Parser extends StaticParser
{
    ...
    private static $expressions = [
        ...
        [
            'numbytes' => 2,
            'freebits' => [5, 6], # 110xxxxx 10xxxxxx
        ...
        [
            'numbytes' => 3,
            'freebits' => [4, 6, 6], # 1110xxxx 10xxxxxx 10xxxxxx
        ...
        [
            'numbytes' => 4,
            'freebits' => [3, 6, 6, 6], # 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx
